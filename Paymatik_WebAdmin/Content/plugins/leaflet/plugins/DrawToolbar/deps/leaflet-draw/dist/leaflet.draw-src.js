...
L.drawLocal = {
	...
	draw: {
		toolbar: {
			...
			buttons: {
				polyline: 'Hat Çiz',
				polygon: 'Serbest Alan Çiz',
				rectangle: 'Dikdörtgen Alan Çiz',
				circle: 'Daire Alan Çiz',
				marker: 'Nokta Ekle',
		...
		handlers: {
			circle: {
				tooltip: {
					start: 'Haritaya Tıkla ve Çizmeye Başla'
				},
				radius: 'Radius'
			},
			circlemarker: {
			...
			marker: {
				tooltip: {
					start: 'Harita Üzerinde Bir Yer Seçiniz.'
				}
			},
			polygon: {
				tooltip: {
					start: 'Başlamak için Haritaya Tıkla',
					cont: 'Diğer Noktaları Ekleyebilirsin',
					end: 'Alanı Tamamlamak için İlk Noktaya Tıklayabilirsin.'
				}
			},
			polyline: {
				error: '<strong>Error:</strong> shape edges cannot cross!',
				tooltip: {
					start: 'Hat Çizimi için Haritaya Tıkla.',
					cont: 'Diğer Noktaları Ekleyebilirsin.',
					end: 'Bitirmek için Çift Tıkla'
				}
			},
			rectangle: {
				tooltip: {
